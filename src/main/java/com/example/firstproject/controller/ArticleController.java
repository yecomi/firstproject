...
public class ArticleController {
    @Autowired// 스프링 부트가 미리 생성해 놓은 리파지터리 객체 주(DI)
    ...
    @GetMapping("/articles/{id}") //데이터 조회 요청 접수 //컨트롤러에서 URL변수를 사용할때는 중괄호 하나만 씀
    ...
    @GetMapping("/articles/{id}/edit") //뷰페이지변수와,컨트롤러에서의 url변수는 다름
